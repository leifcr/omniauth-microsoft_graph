...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Peter Philips", "Joel Van Horn", "Leif Ringstad"]
  spec.email         = ["pete@p373.net", "joel@joelvanhorn.com", "leifcr@gmail.com"]
  ...
  spec.add_runtime_dependency 'omniauth', '~> 2.0', '>= 2.0'
